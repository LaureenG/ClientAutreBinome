...
public class Services {
    ...
    public static String postSurname(String string, String string2) { // "modifier_nom" & NAME & NAME2
    ...
    public static String putSurname(String string, String string2) { // "ajouter_surnom"& NAME &NAME2
        String args[] = new String[4];
